...
export function PostalCodeSchema({
  ...
  const description = `${profession.name} urgente en ${zoneName} (${postalcode}), ${cityName}. Llegamos en un maximo de 30 minutos. Servicio 24h. Presupuesto gratis.`
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: `Nuestros ${profession.namePlural.toLowerCase()} llegan en un maximo de 30 minutos a cualquier punto del codigo postal ${postalcode} (${zoneName}).`,
        },
      },
      {
        "@type": "Question",
