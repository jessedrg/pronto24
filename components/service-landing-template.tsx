...
export function ServiceLandingTemplate({
  ...
  return (
    <div className="relative">
      ...
      {uniqueContent && uniqueContent.testimonials && uniqueContent.testimonials.length > 0 && (
        <section id="opiniones" className="py-16 scroll-mt-20" aria-labelledby="reviews-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-foreground/10 text-foreground text-sm font-medium mb-4">
                <ThumbsUp className="w-4 h-4" />
                <span>Clientes satisfechos en {cityName}</span>
              </div>
              <h2 id="reviews-heading" className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance">
                Lo que dicen nuestros clientes en {cityName}
              </h2>
              <div className="flex items-center justify-center gap-2 mt-3">
                ...
                <span className="text-lg font-bold text-foreground">{uniqueContent.stats.rating}</span>
                <span className="text-sm text-muted-foreground">- Valoracion media en {cityName}</span>
              </div>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              {uniqueContent.testimonials.map((review, i) => (
      ...
      {/* Trust Commitments */}
      <section className="py-12 bg-muted/30 scroll-mt-20" aria-labelledby="trust-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
