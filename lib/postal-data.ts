...
export function getZoneDescription(cp: string, profession: string): string {
  ...
  const descriptions: Record<string, string[]> = {
    fontanero: [
      ...
      `Fontaneros profesionales disponibles 24h en ${zona}, ${city}. Llegamos en un maximo de 30 minutos.`,
    ...
    electricista: [
      ...
      `Servicio electrico 24 horas en ${zona}, ${city}. Tecnicos certificados en un maximo de 30 minutos.`,
    ...
    cerrajero: [
      ...
      `Te has quedado fuera en ${zona}? Cerrajeros en menos de 30 minutos. Codigo postal ${cp}.`,
    ...
    desatascos: [
      ...
      `Atasco en ${zona}? Servicio de desatascos profesional. Llegamos en un maximo de 30 minutos.`,
    ...
    calderas: [
      ...
      `Caldera averiada en ${zona}? Servicio urgente de reparacion. Llegamos en un maximo de 30 minutos.`,
