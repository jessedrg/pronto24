...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!profession) {
    return {
      ...
      description: `Servicio profesional en ${cityName}. Llama: 931 501 817.`,
    }
  }
  ...
  if (modifier) {
    ...
    return {
      title: `${profession.name} ${modifierText} en ${cityName} | 10 Min | 931 501 817`,
      description: `${profession.name} ${modifierText.toLowerCase()} en ${cityName}. ${urgencyText} ${priceText} Profesionales certificados 24/7. Llama GRATIS: 931 501 817`,
      ...
      openGraph: {
        ...
        description: `Servicio de ${profession.name.toLowerCase()} ${modifierText.toLowerCase()} en ${cityName}. Disponibles 24/7. Llama: 931 501 817`,
        type: "website",
      },
    }
  }
  ...
  return {
    title: `${profession.name} en ${cityName} | Urgencias 24h | 931 501 817`,
    description: `${profession.name} profesional en ${cityName}. Llegamos en 10 MIN. Servicio 24h los 365 dias. Presupuesto GRATIS sin compromiso. Llama ahora: 931 501 817`,
    ...
    openGraph: {
      ...
      description: `Servicio de ${profession.name.toLowerCase()} en ${cityName}. Profesionales certificados, llegamos en 10 minutos. Llama: 931 501 817`,
      type: "website",
    },
  }
}
