...
export const metadata: Metadata = {
  title: "Cerrajero Urgente 24h | Apertura en 15 Minutos | Toda España",
  description:
...
const cerrajeroReviews = [
  {
    ...
    rating: 5,
    comment:
      "Me quedé fuera de casa a las 2 AM. Llegaron en 12 minutos y abrieron la puerta sin romper nada. Increíble servicio.",
  ...
  },
  {
    ...
    location: "Barcelona",
    rating: 5,
    comment: "Muy profesionales. Cambiaron el bombín de mi puerta en 20 minutos. Precio justo y trabajo impecable.",
  ...
  },
  {
    ...
    location: "Valencia",
    rating: 5,
    comment: "Rápidos y eficientes. Abrieron mi puerta sin daños y me dieron consejos de seguridad.",
  ...
  },
  {
    ...
    location: "Sevilla",
    rating: 5,
    comment: "Excelente atención. Vinieron en 10 minutos y resolvieron el problema de la cerradura atascada.",
  ...
  },
  {
    ...
    location: "Málaga",
    rating: 5,
    comment: "Muy recomendable. Instalaron una cerradura de seguridad de alta calidad.",
  ...
  },
  {
    ...
    location: "Zaragoza",
    rating: 5,
    comment: "Servicio impecable. Abrieron la puerta sin romper nada y el precio fue razonable.",
