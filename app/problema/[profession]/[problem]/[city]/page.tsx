...
import { MapPin, ArrowRight, Wrench, AlertTriangle, Clock, Euro, Phone, Shield, CheckCircle2, HelpCircle, Lightbulb, Timer, Navigation, ThumbsUp } from "lucide-react"
...
import { generateAggregateRating, generateUniqueContent } from "@/lib/content-generator"
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        {problemContent.testimonials.length > 0 && (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="text-center mb-10">
                ...
                <div className="flex items-center justify-center gap-2 mt-3">
                  ...
                  <span className="text-lg font-bold text-foreground">{problemContent.stats.rating}</span>
                  <span className="text-sm text-muted-foreground">- Valoracion media en {cityName}</span>
                </div>
              </div>
              <div className="grid md:grid-cols-3 gap-6">
                {problemContent.testimonials.map((review, i) => (
