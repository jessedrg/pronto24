...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!profession) {
    return {
      title: `Servicio Rápido ${cityName} | Rapidfix`,
      description: `Servicio rápido en ${cityName}. Llegamos en 10 minutos. Llama: 711 267 223.`,
    }
  }
  return {
    title: `${profession.name} Rápido ${cityName} - Llegamos en 10 Minutos | Rapidfix`,
    description: `${profession.name} rápido en ${cityName}. El servicio más veloz. Llegamos en 10 minutos garantizados. Llama: 711 267 223.`,
    keywords: `${profession.id} rapido ${cityName}, ${profession.id} express ${cityName}, ${profession.id} inmediato ${cityName}`,
  }
}
