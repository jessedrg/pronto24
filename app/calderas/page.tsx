...
export const metadata: Metadata = {
  title: "Reparación de Calderas 24h | Servicio Urgente | Toda España",
  description:
...
const calderasReviews = [
  {
    ...
    rating: 5,
    comment:
      "Mi caldera dejó de funcionar en pleno invierno. Vinieron en 25 minutos y la repararon en el acto. Excelente servicio.",
  ...
  },
  {
    ...
    location: "Barcelona",
    rating: 5,
    comment: "Muy profesionales. Hicieron el mantenimiento anual de mi caldera y me explicaron todo perfectamente.",
  ...
  },
  {
    ...
    location: "Valencia",
    rating: 5,
    comment: "Rápidos y eficientes. La caldera volvió a funcionar perfectamente. Precio justo y sin sorpresas.",
  ...
  },
  {
    ...
    location: "Sevilla",
    rating: 5,
    comment: "Excelente atención. Vinieron el mismo día y solucionaron el problema de agua caliente.",
    service: "Reparación",
    verified: true,
  },
  {
    ...
    location: "Málaga",
    rating: 5,
    comment: "Técnico muy profesional. Explicó el problema claramente y lo resolvió rápido.",
  ...
  },
  {
    ...
    location: "Zaragoza",
    rating: 5,
    comment: "Servicio impecable. La caldera funciona como nueva después de la reparación.",
