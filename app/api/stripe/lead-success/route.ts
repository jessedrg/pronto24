...
<body>
  <div class="container">
    ...
    <div class="card">
      ...
      <h1>Error</h1>
      <p>${message}</p>
      <a href="https://t.me/pronto24_fontaneros" class="btn">Volver a Telegram</a>
    </div>
  </div>
</body>
</html>`
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Lead Comprado - Pronto24</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .tips-title svg { width: 16px; height: 16px; color: #00B8A9; }
...
<body>
  <div class="container">
    <div class="header">
      ...
      <span class="brand">Pronto24</span>
    </div>
    ...
    <div class="card">
      <div class="phone-section">
        ...
        <div class="action-buttons">
          ...
          <a href="https://wa.me/${phoneWhatsApp}?text=Hola%2C%20soy%20profesional%20de%20Pronto24.%20Vi%20que%20necesitas%20ayuda%20con%20${encodeURIComponent(service || "tu problema")}.%20%C2%BFCu%C3%A1ndo%20puedo%20pasar%3F" target="_blank" class="whatsapp-btn">
      ...
      <div class="tips-section">
        ...
        <ul class="tips-list">
          ...
          <li>Preséntate como profesional de Pronto24</li>
    ...
    <div class="footer">
      <a href="https://t.me/pronto24_fontaneros">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
